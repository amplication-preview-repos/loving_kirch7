...
@InputType()
class AssignmentCreateNestedManyWithoutReportsInput {
...
export { AssignmentCreateNestedManyWithoutReportsInput as AssignmentCreateNestedManyWithoutReportsInput };
