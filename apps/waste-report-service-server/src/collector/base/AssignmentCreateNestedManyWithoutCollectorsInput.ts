...
@InputType()
class AssignmentCreateNestedManyWithoutCollectorsInput {
...
export { AssignmentCreateNestedManyWithoutCollectorsInput as AssignmentCreateNestedManyWithoutCollectorsInput };
