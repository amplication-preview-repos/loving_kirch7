...
@InputType()
class AssignmentCreateNestedManyWithoutAuthoritiesInput {
...
export { AssignmentCreateNestedManyWithoutAuthoritiesInput as AssignmentCreateNestedManyWithoutAuthoritiesInput };
